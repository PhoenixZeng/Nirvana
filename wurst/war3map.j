...
//library RegisterAbil:
    function saveAbil takes nothing returns nothing
                ...
                call SaveStr(j_slk_abil, 'Z340', 2081955386, "称号")
                ...
                call SaveStr(j_slk_abil, 'Z350', 2081955386, "称号2")
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_persion_chall_1=Rect(- 1824.0, 3968.0, - 1440.0, 4320.0)
    set gg_rct_persion_chall_2=Rect(- 64.0, 3968.0, 352.0, 4320.0)
    set gg_rct_persion_chall_3=Rect(1696.0, 3904.0, 2080.0, 4320.0)
    set gg_rct_persion_chall_4=Rect(3392.0, 4000.0, 3776.0, 4384.0)
    set gg_rct_persion_chall_5=Rect(5216.0, 4000.0, 5568.0, 4352.0)
    set gg_rct_persion_return_1=Rect(- 1728.0, 4448.0, - 1600.0, 4576.0)
    set gg_rct_persion_return_2=Rect(32.0, 4448.0, 160.0, 4576.0)
    set gg_rct_persion_return_3=Rect(1792.0, 4416.0, 1920.0, 4544.0)
    set gg_rct_persion_return_4=Rect(3424.0, 4448.0, 3616.0, 4576.0)
    set gg_rct_persion_return_5=Rect(5248.0, 4480.0, 5440.0, 4608.0)
