...
//library RegisterAbil:
    function saveAbil takes nothing returns nothing
                ...
                call SaveStr(j_slk_abil, 'Z140', 2081955386, "皮肤")
            
                call SaveStr(j_slk_abil, 'Z140', - 844856191, "角色可激活的皮肤!")
            
                call SaveStr(j_slk_abil, 'Z141', 2081955386, "[皮肤]风暴死亡骑士")
            
                call SaveStr(j_slk_abil, 'Z141', - 844856191, "|n|cFFFFFF55附加属性|r(%)|n攻击吸血:3|n附加伤害:30|n|n激活后输入'-pf1'切换皮肤和皮肤属性效果!")
            
                        call SaveInteger(j_slk_abil, 'Z141', 10, 3)
        
                        call SaveInteger(j_slk_abil, 'Z141', 11, 30)
        
                call SaveStr(j_slk_abil, 'Z142', 2081955386, "[皮肤]风暴大主教")
            
                call SaveStr(j_slk_abil, 'Z142', - 844856191, "|n|cFFFFFF55附加属性|r(%)|n力量增幅:20|n敏捷增幅:20|n智力增幅:20|n|n激活后输入'-pf2'切换皮肤和皮肤属性效果!")
            
                        call SaveInteger(j_slk_abil, 'Z142', 19, 20)
        
                        call SaveInteger(j_slk_abil, 'Z142', 20, 20)
        
                        call SaveInteger(j_slk_abil, 'Z142', 21, 20)
        
                call SaveStr(j_slk_abil, 'Z143', 2081955386, "[皮肤]雅典娜")
            
                call SaveStr(j_slk_abil, 'Z143', - 844856191, "|n|cFFFFFF55附加属性|r(%)|n伤害增幅:60|n|n激活后输入'-pf3'切换皮肤和皮肤属性效果!")
            
                        call SaveInteger(j_slk_abil, 'Z143', 7, 60)
        
                call SaveStr(j_slk_abil, 'Z144', 2081955386, "[皮肤]白夜")
            
                call SaveStr(j_slk_abil, 'Z144', - 844856191, "|n|cFFFFFF55附加属性|r(%)|n暴击概率:10|n暴击伤害:60|n|n激活后输入'-pf4'切换皮肤和皮肤属性效果!")
            
                        call SaveInteger(j_slk_abil, 'Z144', 8, 10)
                ...
                call SaveStr(j_slk_abil, 'Z325', - 844856191, "|cFFFFFF99基础属性|r|n攻击:30000|n|cFFFFFF55附加属性|r(%)|n暴击伤害:88|n属性叠加!拥有多个时只能使用一个!|n激活后输入'-wq5'切换皮肤!")
            
                        call SaveInteger(j_slk_abil, 'Z325', 0, 30000)
        
                        call SaveInteger(j_slk_abil, 'Z325', 9, 88)
                ...
                call SaveStr(j_slk_abil, 'Z333', - 844856191, "|cFFFFFF99基础属性|r|n力量:10000|n敏捷:10000|n智力:10000|n|cFFFFFF55附加属性|r(%)|n附加伤害:30|n属性叠加!拥有多个时只能使用一个!|n激活后输入'-cb3'切换翅膀!")
            
                        call SaveInteger(j_slk_abil, 'Z333', 4, 10000)
        
                        call SaveInteger(j_slk_abil, 'Z333', 5, 10000)
        
                        call SaveInteger(j_slk_abil, 'Z333', 6, 10000)
        
                        call SaveInteger(j_slk_abil, 'Z333', 11, 30)
                ...
                call SaveStr(j_slk_abil, 'Z337', 2081955386, "花蝶翅膀")
            
                call SaveStr(j_slk_abil, 'Z337', - 844856191, "|cFFFFFF99基础属性|r|n力量:15000|n敏捷:15000|n智力:15000|n|cFFFFFF55附加属性|r(%)|n暴击概率:10|n附加伤害:50|n属性叠加!拥有多个时只能使用一个!|n激活后输入'-cb7'切换翅膀!")
            
                        call SaveInteger(j_slk_abil, 'Z337', 4, 15000)
        
                        call SaveInteger(j_slk_abil, 'Z337', 5, 15000)
        
                        call SaveInteger(j_slk_abil, 'Z337', 6, 15000)
        
                        call SaveInteger(j_slk_abil, 'Z337', 8, 10)
        
                        call SaveInteger(j_slk_abil, 'Z337', 11, 50)
...
//library RegisterItem:
    function saveItem takes nothing returns nothing
                    ...
                    call SaveStr(j_slk_item, 'Y141', 2081955386, "[皮肤]风暴死亡骑士")
                
                    call SaveStr(j_slk_item, 'Y141', - 844856191, "激活皮肤")
                
                    call SaveStr(j_slk_item, 'Y142', 2081955386, "[皮肤]风暴大主教")
                
                    call SaveStr(j_slk_item, 'Y142', - 844856191, "激活皮肤")
                
                    call SaveStr(j_slk_item, 'Y143', 2081955386, "[皮肤]雅典娜")
                
                    call SaveStr(j_slk_item, 'Y143', - 844856191, "激活皮肤")
                
                    call SaveStr(j_slk_item, 'Y144', 2081955386, "[皮肤]白夜")
                    ...
                    call SaveStr(j_slk_item, 'Y337', 2081955386, "[翅膀皮肤]花蝶翅膀")
                
                    call SaveStr(j_slk_item, 'Y337', - 844856191, "激活翅膀皮肤")
...
//library RegisterUnit:
    function saveUnit takes nothing returns nothing
                    ...
                    call SaveStr(j_slk_unit, 'H724', 2081955386, "|cFF33FF00虚空爪牙|r")
                
                    call SaveInteger(j_slk_unit, 'H724', 406492257, 4)
                
                    call SaveStr(j_slk_unit, 'H725', 2081955386, "|cFF33FF00被腐化的秘境守卫|r")
                    ...
                    call SaveStr(j_slk_unit, 'NP0D', 2081955386, "皮肤兑换")
                    ...
                    call SaveStr(j_slk_unit, 'h604', 2081955386, "被腐化的树精")
                
                    call SaveInteger(j_slk_unit, 'h604', 406492257, 1)
...
//library itemRecipeAgent:
    function itemRecipeAgentInit takes nothing returns nothing
            ...
            call SaveInteger(j_slk_item, 'I65G', 406492257, 0)
            call SaveInteger(j_slk_item, 'I65G', - 85356197, 0)
        
            call SaveInteger(j_slk_item, 'I65H', 406492257, 0)
            call SaveInteger(j_slk_item, 'I65H', - 85356197, 0)
        
            call SaveInteger(j_slk_item, 'I65I', 406492257, 0)
            call SaveInteger(j_slk_item, 'I65I', - 85356197, 0)
        
            call SaveInteger(j_slk_item, 'I65J', 406492257, 0)
            call SaveInteger(j_slk_item, 'I65J', - 85356197, 0)
        
            call SaveInteger(j_slk_item, 'I65K', 406492257, 0)
            call SaveInteger(j_slk_item, 'I65K', - 85356197, 0)
        
            call SaveInteger(j_slk_item, 'I65L', 406492257, 0)
            call SaveInteger(j_slk_item, 'I65L', - 85356197, 0)
        
            call SaveInteger(j_slk_item, 'I65M', 406492257, 0)
            call SaveInteger(j_slk_item, 'I65M', - 85356197, 0)
